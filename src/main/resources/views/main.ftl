...
<#--                    <#if permissions?seq_contains("10")>-->
                        ...
                        <dl class="layui-nav-child">
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-2" data-tab="cdp/index" target="_self"><i class="fa fa-ellipsis-h"></i><span class="layui-left-nav"> 本院概况</span></a>
                                </dd>
                        </dl>
                    </li>
<#--                    </#if>-->
<#--                    <#if permissions?seq_contains("20")>-->
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 住院情况</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3" data-tab="customer/index" target="_self"><i class="fa fa-exchange"></i><span class="layui-left-nav"> 康复情况</span></a>
                                    </dd>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-4" data-tab="customer_loss/index" target="_self"><i class="fa fa-user-times"></i><span class="layui-left-nav"> 病房管理</span></a>
                                    </dd>
                            </dl>
                        </li>
<#--                    </#if>-->
